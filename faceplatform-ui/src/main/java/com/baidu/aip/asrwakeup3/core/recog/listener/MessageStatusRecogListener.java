...
public class MessageStatusRecogListener extends StatusRecogListener {
    ...
    public void onAsrReady() {
        ...
        sendMessage("初始化成功", IAsrState.WAKE_INIT_SUCCESS, true);
    ...
    public void onAsrVolume(int volumePercent, int volume) {
        ...
        sendMessage(volumePercent+"", IStatus.STATUS_VOLUME, false);
    }
    ...
    public void onAsrFinalResult(String[] results, RecogResult recogResult) {
        ...
        sendMessage(message,IAsrState.STATUS_FINISHED, true);
    }
    ...
    public void onAsrFinishError(int errorCode, int subErrorCode, String descMessage,
        ...
        sendMessage(message, IAsrState.WAKE_INIT_FAILED, true);
    }
