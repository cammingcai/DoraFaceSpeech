 ...
 * 人脸检测区域View
 */
public class FaceDetectRoundView2 extends View {

    private static final String TAG = FaceDetectRoundView2.class.getSimpleName();
...
//    public static final int COLOR_ROUND = Color.parseColor("#FFA800");
    ...
    public static final int COLOR_BG = Color.parseColor("#002F2F33");
    public static final int COLOR_RECT = Color.parseColor("#00FFFFFF");
    public static final int COLOR_ROUND = Color.parseColor("#00FFA800");
    ...
    public FaceDetectRoundView2(Context context, AttributeSet attrs) {
        super(context, attrs);
