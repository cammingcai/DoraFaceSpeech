...
public class FaceDetectExpActivity extends FaceDetectActivity {
    ...
    public void onDetectCompletion(FaceStatusEnum status, String message, HashMap<String, String> base64ImageMap) {
        ...
        Log.i("FaceDetectExpActivity","status="+status);
        Log.i("FaceDetectExpActivity","base64ImageMap="+base64ImageMap);

        if (status == FaceStatusEnum.OK ) {
            Toast.makeText(FaceDetectExpActivity.this,"ok",Toast.LENGTH_SHORT).show();
        }
