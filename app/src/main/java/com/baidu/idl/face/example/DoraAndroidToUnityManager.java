...
import com.baidu.idl.face.platform.IFaceListener;
...
public class DoraAndroidToUnityManager {
    ...
    public boolean initFaceLiveness() {
       boolean initFace =  FaceSDKManager.getInstance().initialize(getActivity(), com.baidu.idl.face.platform.Config.licenseID, Config.licenseFileName);
//       if(initFace)
//           setFaceConfig();
       return initFace;
     ...
     * 初始化人脸采集
     */
    public boolean initFaceLiveness(Context context) {
        boolean initFace =  FaceSDKManager.getInstance().initialize(context, com.baidu.idl.face.platform.Config.licenseID, Config.licenseFileName);
//       if(initFace)
//           setFaceConfig();
        return initFace;
...
//        if(dialog==null)
//            dialog = new MyDialog1(context, R.layout.activity_face_liveness_v3100);
//        dialog.mIsCompletion = false;
//        dialog.setCanceledOnTouchOutside(false);
//        dialog.show();
//        dialog.setFaceListener(new IFaceListener() {
